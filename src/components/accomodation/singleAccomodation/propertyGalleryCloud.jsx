...
export default function PropertyGalleryCloud({ property }) {
  const [folders, setFolders] = useState([]);
  const [selectedFolder, setSelectedFolder] = useState(`${property.slug} || " "`);
      ...
      {/* <div className="respons sektion md:grid-cols-5">
        <div className="col-span-4">
          <Title
            ...
            subHeading="Gallery"
            first="Memories from our Accomodations"
          />
        </div>
        <div>
